...
package com.cllor.var;

// class 선언문,class prototype
public class Var_01 {
	//여기서 부터 실제 명령문 코드가 작성되는 곳
	public static void main(String[] args) {
		 ...
		 * 정수형 변수 num2 를 선언하고 정수88 값으로 초기화 하라.
		 */
		int num1 = 255;
		int num2 = 88;
		...
		//대입 할당,저장
		num3 = 40;
		// 선언된 정수형 변수 num4에 정수 100dmf eodlqgkrl
		num4 = 100;
		/*
		 ...
		 * 		=>camle case
		 * 5. 두개 이상의 단어를 조합할때 철번째 단어는 변수의 type으로 만드는 것이 좋다
		 * 		=> 헝가리언 표기법
		 */
		int intNum1 = 0;
		/**
		...
		int intStNum = 20220323;
		int intStAge = 33;
		
		System.out.println(intStAge + intNum1);
