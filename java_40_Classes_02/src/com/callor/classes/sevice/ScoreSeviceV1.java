...
public class ScoreSeviceV1 {
	...
	public ScoreSeviceV1(int length) {
	...
	public int input() {
		...
		/*
		 * 입력을 배열의 개수만큼 모두 마치고 정상 종료 하면 0 을 return 
		 * 입력 도중 END 를 입력하여 중단 하였으므로 -1을 return
		 */
