...
public class Var_03 {
	...
	public static void main(String[] args) {
		...
		// boolen type 의 변수 초기화 할때는
		// true 값를 주로 사용한다
		boolean bEven = true;

		bEven = (intNum1 % 2) == 0;
		/*
		 * 비교(조건) 명령문 if(boolen) { boolean 이 true 일때 실행 } else {boolean 이 true가 아닐때 실행}
		 * boolean 의 값이 true 인가 false 인가에 따라서 명령문을 선택적으로 실행할수있다
		 */
		if (bEven) {
