...
public class ScoreServiceImplV1 implements ScoreService {
	 ...
	 * 데이터 손상을 방지하고 데이터가 저장된 상태에서 임의의 또다시 초기화 되는 것을 방지하기. 초기화 하지 않으면 오류가 나서
	 * NullpointExerption 도 막을 수 있다.
	 * 
	 */
	...
	public ScoreServiceImplV1() {
		...
		// 생성자에서 리스트 객체를 초기화 하여
		// NullpointExerption 을 사전에 예방한다
