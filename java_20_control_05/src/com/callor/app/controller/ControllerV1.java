...
public class ControllerV1 {
	public static void main(String[] args) {
		...
		// 1. 클래스를 사용하여 변수 처럼 객체(object)를 선언하고
		// -> import com.callor.app.service.ServiceV1; : ctrl+shift+ 영문O
		// 2. new 키워드와 생성자 method 를 사용하여
		// 3. 객체를 인스턴스화 시킨다.
		//   1.         2.            3.
		 ServiceV1 serviceV1 = new ServiceV1();// new ServiceV1() : 생성자
		 ...
		 /*
		  * scoerSum()은 return type int 형이다
		  * scoerSum() 과목의 총점을 계산하여 결과를 return 하고 있다
		  * main () 에서는 scoerSum() 를 호출하여 결과를 어딘가에 담아서
		  * 출력하는 일을 수행해야 하는데
