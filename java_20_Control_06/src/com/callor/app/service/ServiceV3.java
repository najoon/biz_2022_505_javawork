...
/*
 * scoreSum() 에서 계산한 총점과
 * scorePrint 에서 출력한 과목점수와의 관\계는 완전히 문제가 발생했다
 * 두 method  에 선언되 intKor, inrEng, intMath 는 이름은 같지만
 * 완전히 다른 변수 이다
 * 
 * 총점을 scorePrint() 에서 직접 계산하면 되겠지만
 * scoreSum() 을 사용하여 총점을 계산하고 싶다
 * 
 *  이러한 문제를 해결하기 위하여  ServiceV4 gogo
 */
public class ServiceV3 {
	...
	public void scorePrint() {
		 ...
		 * String  클래스에는 문자열을 다루는 다양한 method 들이 이미 준비되어있다
		 * 다양한 method 를 손쉽게 사용할 수 있다.
		 */
		String dLine = "=";
