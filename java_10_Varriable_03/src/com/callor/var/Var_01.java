...
public class Var_01 {
	 ...
	 * 	사용되면 마치 키워드 처럼 작동되다
	 * public static void main() java 시작저므 진입점  method 명령 그룹이라고 한다.
	 * 
	...
	public static void main(String[] args) {
		...
		// 작동 되기도 하고 없으면 문법 오류를 발생하기도 한다.
		// method 에 첨가되는  args 는 method 코드가 만들어 질때 정해지는 것으로 특별한 규칙이 없다.
