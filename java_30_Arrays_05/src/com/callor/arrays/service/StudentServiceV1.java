...
public class StudentServiceV1 {
	...
	public StudentServiceV1() {
		...
		/*
		 * strStudents, scan 두개의 변수는 초기화가 되어야 하는데 생성자에 초기화 시키는 코드를 작성한다 하지만 현재 ServiceV1
		 * 클래스에는 두개의 생성자가 있다 그래서 기본생성자에서는 임의 생성자에게 정수 10을 전달하면서 strStudents 와 scan 두개의
